...
# Pam Downey Mac
node 'cdb-mac-06099.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Sue Abshire Mac
node 'cdb-mac-06228.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
node 'cdb-mac-06098.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Amber Billow Mac
node 'cdb-mac-06097.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Laurie Gilson Mac
node 'cdb-mac-06195.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Kelli Good Mac
node 'cdb-mac-06194.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
node 'cdb-mac-06096.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Denine Cramer Mac
node 'cdb-mac-06095.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Bev Junge Mac
node 'cdb-mac-06193.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Jen Kin Mac
node 'cdb-mac-06192.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
node 'cdb-mac-06208.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Linda Martinez Mac
node 'cdb-mac-06232.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Vaune Ritchey Mac
node 'cdb-mac-06227.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Kylie Spieser Mac
node 'cdb-mac-06209.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Lainee Meyer Mac
node 'cdb-mac-06230.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Linsday Murray Mac
node 'cdb-mac-06231.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Beverly Nye
node 'cdb-mac-06229.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Susie Wagner Mac
node 'cdb-mac-06226.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Deb Wesche Mac
node 'cdb-mac-06225.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
node 'cdb-mac-06224.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
...
# Sue Goebel  Mac
node 'cdb-mac-06223.nas.local' inherits 'macbasenode' {
  class { 'nacs_management::allprinters': }
