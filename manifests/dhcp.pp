node 'dhcp.nas.local' {
  ...
  dhcp::server::subnet { '10.20.11.0':
    ...
    range_begin => '10.20.11.100',
    range_end   => '10.20.11.200',
    filename    => 'pxelinux.0',
    next_server => '10.20.2.35',
    domain_name => 'nas.local',
    dns_servers => ['10.20.15.26', '10.20.15.48', '10.20.15.25'],
  ...
  dhcp::server::subnet { '10.20.21.0':
    ...
    range_begin => '10.20.21.100',
    range_end   => '10.20.21.200',
    filename    => 'pxelinux.0',
    next_server => '10.20.2.35',
    domain_name => 'nas.local',
    dns_servers => ['10.20.15.26', '10.20.15.48', '10.20.15.25'],
